...
const DAILY_QUIZ_URL_PATTERN = "https://www.geoguessr.com/api/v4/daily-quiz/*";
...
chrome.webRequest.onCompleted.addListener(
  (details) => {
    ...
    if (details.method !== "GET" || details.statusCode !== 200) {
      log("Ignored request (not GET 200).");
      return;
    }
    ...
    const roundSummary = {
      ...
      guess:
        ...
        typeof guess.lng === "number"
          ...
          : null,
      correct:
        typeof pano.lat === "number" &&
        typeof pano.lng === "number"
